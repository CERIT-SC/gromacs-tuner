...
def test_ewald_default_no_ewald_block_added():
    result = patch_mdin_for_benchmark(MINIMAL_MDIN, nsteps=10000, ewald=EwaldPreset.DEFAULT)
    assert "&ewald" not in result


def test_ewald_optimized_adds_ewald_block():
...
def test_ewald_optimized_existing_ewald_block_overridden():
